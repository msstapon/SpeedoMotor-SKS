...
class NewCollectionYamaha extends StatefulWidget {
  ...
  final String step;
  final String brand;
  NewCollectionYamaha({Key key, @required this.type, @required this.step, this.brand}) : super(key: key);
  @override
  _NewCollectionYamahaState createState() => _NewCollectionYamahaState();
}

class _NewCollectionYamahaState extends State<NewCollectionYamaha> {
