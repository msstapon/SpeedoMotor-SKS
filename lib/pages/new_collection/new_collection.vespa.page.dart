...
class CollectionVespa extends StatefulWidget {
  final String type;
  final String step;
  final String brand;
  CollectionVespa({Key key, @required this.type, @required this.step, this.brand}) : super(key: key);
  @override
  _CollectionVespaState createState() => _CollectionVespaState();
}

class _CollectionVespaState extends State<CollectionVespa> {
  List<String> nameCar = [
    'Vespa125',
    'Vespa150',
    'Vespa300',
          ...
          Container(
            ...
            decoration: BoxDecoration(
              image: DecorationImage(
                image: AssetImage("lib/images/collection_motor/new_icon/sks-page-19-260.png"),
                fit: BoxFit.fill,
              ),
            ),
