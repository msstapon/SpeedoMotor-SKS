...
class CollectionYamahaGear extends StatefulWidget {
  final String type;
  final String step;
  final String brand;
  CollectionYamahaGear({Key key, @required this.type, @required this.step, this.brand}) : super(key: key);
  @override
  _CollectionYamahaGearState createState() => _CollectionYamahaGearState();
}

class _CollectionYamahaGearState extends State<CollectionYamahaGear> {
  List<String> nameCar = [
    'Exciter150',
    'R15',
          ...
          Container(
            ...
            decoration: BoxDecoration(
              image: DecorationImage(
                image: AssetImage("lib/images/collection_motor/new_icon/sks-page-09-140.png"),
                fit: BoxFit.fill,
              ),
            ),
