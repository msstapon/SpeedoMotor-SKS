...
class CollectionHondaGear extends StatefulWidget {
  final String type;
  final String step;
  final String brand;
  CollectionHondaGear({Key key, @required this.type, @required this.step, this.brand}) : super(key: key);
  @override
  _CollectionHondaGearState createState() => _CollectionHondaGearState();
}

class _CollectionHondaGearState extends State<CollectionHondaGear> {
  List<String> nameCar = [
    'W110i',
    'Sonic',
    'W125i',
